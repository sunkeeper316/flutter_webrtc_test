...
class TestOneView extends BaseView {
  TestOneView({required super.title});

  // const MyHomePage({super.key, required this.title});
  // final String title;
  @override
  TestOneState createState() => TestOneState();
}

class TestOneState extends BaseState {
      ...
      appBar: AppBar(
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(maintainState: false, builder : (BuildContext context) => CallView(title: 'TestTwoView',))) ;
            },
          ),
        ],
        title: Text('TestOneView'),
      ),
      body: Column(
