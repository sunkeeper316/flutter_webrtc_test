...
class TestTwoView extends BaseView {
  TestTwoView({required super.title});
  // const MyHomePage({super.key, required this.title});
  // final String title;
  @override
  TestTwoState createState() => TestTwoState();
}
      ...
      appBar: AppBar(
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => TestThreeView(title: 'TestThreeView',)));
            },
          ),
        ],
        title: Text('TestTwoView'),
      ),
      body: Column(
